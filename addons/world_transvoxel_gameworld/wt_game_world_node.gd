...
func get_game_world_summary() -> Dictionary:
	...
	return {
		...
		"interaction_warm_requests": int(metrics.get("interaction_warm_requests", 0)),
		"interaction_warm_admissions": int(metrics.get("interaction_warm_admissions", 0)),
		"interaction_warm_coalesced": int(metrics.get("interaction_warm_coalesced", 0)),
		"interaction_warm_cache_hits": int(metrics.get("interaction_warm_cache_hits", 0)),
		"interaction_warm_completions": int(metrics.get("interaction_warm_completions", 0)),
		"interaction_warm_rejections": int(metrics.get("interaction_warm_rejections", 0)),
		"interaction_local_plan_refreshes": int(metrics.get("interaction_local_plan_refreshes", 0)),
		"interaction_local_plan_added_chunks": int(metrics.get("interaction_local_plan_added_chunks", 0)),
		"interaction_local_plan_rejections": int(metrics.get("interaction_local_plan_rejections", 0)),
		"interaction_local_plan_ns_maximum": int(metrics.get("interaction_local_plan_ns_maximum", 0)),
