...
const PIPELINE_METRICS := [
	...
	"mesh_worker_count", "mesh_worker_accepted_jobs",
	"mesh_worker_started_jobs", "mesh_worker_completed_jobs",
	"mesh_worker_queue_rejections", "mesh_worker_cancelled_queued_jobs",
	"mesh_worker_reprioritized_queued_jobs", "mesh_worker_queued_jobs",
	"mesh_worker_queued_completions", "mesh_worker_active_jobs",
	"mesh_worker_maximum_active_jobs", "mesh_worker_queue_wait_ns_last",
	"mesh_worker_queue_wait_ns_total", "mesh_worker_queue_wait_ns_maximum",
	...
	"first_blocked_replacement_key_z", "first_blocked_replacement_key_lod",
