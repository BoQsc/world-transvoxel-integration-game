#!/usr/bin/env python3
"""Run the default-off production resident lifecycle smoke on three CPUs."""
...
PASS_MARKER = "GPU_RESIDENT_PRODUCTION_LIFECYCLE_SMOKE_PASS"
...
def run_profile(godot: pathlib.Path, project: pathlib.Path, driver: str) -> int:
    ...
    command = [
        ...
        str(log_path),
        "--script",
        "res://tests/gpu_resident_production_lifecycle_smoke.gd",
    ]
    ...
    relevant = [
        ...
        if "GPU_RESIDENT_PRODUCTION_LIFECYCLE" in line
