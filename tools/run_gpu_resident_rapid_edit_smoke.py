#!/usr/bin/env python3
"""Run the bounded resident rapid cross-chunk edits smoke on three CPUs."""
...
PASS_MARKER = "GPU_RESIDENT_RAPID_EDIT_SMOKE_PASS"
...
def run_profile(godot: pathlib.Path, project: pathlib.Path, driver: str) -> int:
    ...
    command = [
        ...
        str(log_path),
        "--script",
        "res://tests/gpu_resident_rapid_edit_smoke.gd",
    ]
    ...
    relevant = [
        ...
        if "GPU_RESIDENT_RAPID_EDIT" in line
