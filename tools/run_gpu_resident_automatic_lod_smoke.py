#!/usr/bin/env python3
"""Run the bounded autonomous resident LOD smoke on three CPUs."""
...
PASS_MARKER = "GPU_RESIDENT_AUTOMATIC_LOD_SMOKE_PASS"
...
def run_profile(godot: pathlib.Path, project: pathlib.Path, driver: str) -> int:
    ...
    command = [
        ...
        str(log_path),
        "--script",
        "res://tests/gpu_resident_automatic_lod_smoke.gd",
    ]
    ...
    relevant = [
        ...
        if "GPU_RESIDENT_AUTOMATIC_LOD" in line
