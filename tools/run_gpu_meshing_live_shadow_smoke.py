#!/usr/bin/env python3
"""Run live TQP-64 GPU shadow validation on at most three logical CPUs."""
...
MARKER = "GPU_MESHING_LIVE_SHADOW_SMOKE_PASS"
...
def main() -> int:
    ...
    log_root = project / ".godot" / "world_transvoxel_captures" / "gpu_meshing_live_shadow"
    ...
    command = [
        ...
        str(log_path),
        "--script",
        "res://tests/gpu_meshing_live_shadow_smoke.gd",
    ]
    ...
    relevant = [
        ...
        if "GPU_MESHING_LIVE_SHADOW" in line or line.startswith("ERROR:")
    ]
