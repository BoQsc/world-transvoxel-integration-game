#!/usr/bin/env python3
"""Run the full-resolution first edit smoke on three CPUs."""
...
PASS_MARKER = "GPU_RESIDENT_FULL_QUALITY_EDIT_SMOKE_PASS"
...
def run_profile(godot: pathlib.Path, project: pathlib.Path, driver: str) -> int:
    log_root = (
        ...
        / "gpu_resident_full_quality_edit"
    )
    ...
    command = [
        ...
        str(log_path),
        "--script",
        "res://tests/gpu_resident_full_quality_edit_smoke.gd",
    ]
    ...
    relevant = [
        ...
        if "GPU_RESIDENT_FULL_QUALITY_EDIT" in line
